...
describe Thor::Shell::Basic do
  ...
  describe "#ask" do
    ...
    it "prints a message to the user with the available options and reasks the question_page after an incorrect repsonse" do
      flavors = %w[strawberry chocolate vanilla]
    ...
    it "prints a message to the user with the available options and reasks the question_page after an incorrect repsonse and then returns the default" do
      flavors = %w[strawberry chocolate vanilla]
      expect($stdout).to receive(:print).with("Your response must be one of: [strawberry, chocolate, vanilla]. Please try again.\n")
